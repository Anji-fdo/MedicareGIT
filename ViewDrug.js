...
export default function ViewDrug() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`http://localhost:8070/drug/get/${id}`);
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`http://localhost:8070/drug/delete/${id}`);
            navigate('/');
        } catch (error) {
            ...
            <div className="container">
                ...
                <div className="row d-flex justify-content-center align-middle h-100 mt-5">
                    <div className="col-6 shadow-lg p-3 mb-5 bg-white rounded">
                        ...
                        <img src={`http://localhost:8070/${drug.file.replace(/\\/g, '/')}`} alt="Drug" style={{ height: 200 }} />
                        ...
                        <div className="container text-start mx-5 mt-5">
                            ...
                            <div className='row mt-4'>
                                <div className='col-5'>
                                    <Link to={`/update/${id}`} className="btn btn-primary col-12 ms-2">
                                        Update
                                    </Link>
                                </div>
